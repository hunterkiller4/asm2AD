...
namespace EndToEnd.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            ViewBag.CCID = new SelectList(db.CCs, "CCID", "CCName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CourseID,CourseName,CourseDescription,CCID")] Course course)
        {
            ...
            ViewBag.CCID = new SelectList(db.CCs, "CCID", "CCName", course.CCID);
            return View(course);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseID,CourseName,CourseDescription,CCID")] Course course)
        {
            if (ModelState.IsValid)
            {
